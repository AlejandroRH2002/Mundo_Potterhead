    ...
    <div className="bg-gradient-to-br from-[#4a0001] via-[#740001] to-[#4a0001] min-h-screen pt-24">
      <div className="content-wrapper max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mt-6 p-4 bg-white/5 rounded-lg border border-[#FDB813]/20">
                <h4 className="text-white font-cinzel font-bold mb-2 text-sm">Consejos para nuevos productos:</h4>
                <ul className="text-white/70 text-xs space-y-1">
                  <li><strong>Imágenes:</strong> Usa imágenes de Unsplash o similares</li>
                  <li><strong>Nombre:</strong> Claro y descriptivo</li>
                  <li><strong>Descripción:</strong> Incluye detalles relevantes</li>
                  <li><strong>Precio:</strong> Realista y competitivo</li>
                  <li><strong>Universo:</strong> Selecciona el correcto</li>
                  <li><strong>Categoría:</strong> Ayuda a organizar la tienda</li>
                  <li><strong>Oferta:</strong> Solo si hay descuento real</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 text-center text-white/50 text-xs font-cinzel">
          <p>
            Los productos aparecerán en la sección correspondiente según el universo seleccionado.
            <br />
            <span className="text-[#FDB813]">Harry Potter</span> → Página principal | 
            <span className="text-pink-400"> Otros Universos</span> → Sección dedicada
          </p>
        </div>
      </div>
    </div>
